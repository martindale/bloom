...
return (function (p__7922){
var vec__7923 = p__7922;
var attr = cljs.core.nth.call(null,vec__7923,(0),null);
var v = cljs.core.nth.call(null,vec__7923,(1),null);
...
var args7926 = [];
var len__7621__auto___7929 = arguments.length;
var i__7622__auto___7930 = (0);
while(true){
if((i__7622__auto___7930 < len__7621__auto___7929)){
args7926.push((arguments[i__7622__auto___7930]));

var G__7931 = (i__7622__auto___7930 + (1));
i__7622__auto___7930 = G__7931;
continue;
} else {
}
break;
...
var len__7621__auto___7934 = arguments.length;
var i__7622__auto___7935 = (0);
while(true){
if((i__7622__auto___7935 < len__7621__auto___7934)){
args__7628__auto__.push((arguments[i__7622__auto___7935]));

var G__7936 = (i__7622__auto___7935 + (1));
i__7622__auto___7935 = G__7936;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__7629__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq7933){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7933));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__7937){
...
var G__7943 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
...
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__7944){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__7951){
var map__7955 = p__7951;
var map__7955__$1 = ((((!((map__7955 == null)))?((((map__7955.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7955.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7955):map__7955);
var messages = map__7955__$1;
var warnings = cljs.core.get.call(null,map__7955__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7955__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__7957 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__7957,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__7957,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__7958){
...
var messages = map__7961__$1;
var warnings = cljs.core.get.call(null,map__7961__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7961__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__7961,map__7961__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__7961,map__7961__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__7961,map__7961__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__7961,map__7961__$1,messages,warnings,exception))
;
