...
om.next.impl.parser.union_entry__GT_ast = (function om$next$impl$parser$union_entry__GT_ast(p__29687){
var vec__29691 = p__29687;
var k = cljs.core.nth.call(null,vec__29691,(0),null);
var v = cljs.core.nth.call(null,vec__29691,(1),null);
...
om.next.impl.parser.call__GT_ast = (function om$next$impl$parser$call__GT_ast(p__29694){
var vec__29699 = p__29694;
var f = cljs.core.nth.call(null,vec__29699,(0),null);
var args = cljs.core.nth.call(null,vec__29699,(1),null);
var call = vec__29699;
...
return cljs.core.assoc.call(null,G__29702,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"call","call",-519999866));
} else {
return G__29702;
}
}
...
var vec__29706 = cljs.core.first.call(null,join);
...
om.next.impl.parser.ident__GT_ast = (function om$next$impl$parser$ident__GT_ast(p__29709){
var vec__29713 = p__29709;
var k = cljs.core.nth.call(null,vec__29713,(0),null);
var id = cljs.core.nth.call(null,vec__29713,(1),null);
var ref = vec__29713;
...
return cljs.core.with_meta.call(null,(function (){var G__29717 = expr;
if((expr instanceof cljs.core.Keyword)){
var x__21067__auto__ = G__29717;
...
var args29721 = [];
var len__21324__auto___29738 = arguments.length;
var i__21325__auto___29739 = (0);
while(true){
if((i__21325__auto___29739 < len__21324__auto___29738)){
args29721.push((arguments[i__21325__auto___29739]));

var G__29740 = (i__21325__auto___29739 + (1));
i__21325__auto___29739 = G__29740;
continue;
} else {
}
break;
...
om.next.impl.parser.ast__GT_expr.cljs$core$IFn$_invoke$arity$2 = (function (p__29724,unparse_QMARK_){
...
var ast = map__29725__$1;
var type = cljs.core.get.call(null,map__29725__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var component = cljs.core.get.call(null,map__29725__$1,new cljs.core.Keyword(null,"component","component",1555936782));
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),type)){
var G__29727 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,((function (map__29725,map__29725__$1,ast,type,component){
return (function (p1__29718_SHARP_){
return om.next.impl.parser.ast__GT_expr.call(null,p1__29718_SHARP_,unparse_QMARK_);
});})(map__29725,map__29725__$1,ast,type,component))
),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(ast));
if(!((component == null))){
return cljs.core.with_meta.call(null,G__29727,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component","component",1555936782),component], null));
} else {
return G__29727;
}
} else {
...
var key = cljs.core.get.call(null,map__29728__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var query = cljs.core.get.call(null,map__29728__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var query_root = cljs.core.get.call(null,map__29728__$1,new cljs.core.Keyword(null,"query-root","query-root",359781888));
var params = cljs.core.get.call(null,map__29728__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
})():((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"join","join",-758861890),type))?(((cljs.core.not_EQ_.call(null,new cljs.core.Symbol(null,"...","...",-1926939749,null),query)) && (!(typeof query === 'number')) && (unparse_QMARK_ === true))?(function (){var map__29730 = ast;
...
var children = cljs.core.get.call(null,map__29730__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.PersistentArrayMap.fromArray([key,cljs.core.into.call(null,(function (){var G__29732 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(component)){
return cljs.core.with_meta.call(null,G__29732,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component","component",1555936782),component], null));
} else {
return G__29732;
}
})(),cljs.core.map.call(null,((function (map__29730,map__29730__$1,children,map__29728,map__29728__$1,key,query,query_root,params,map__29725,map__29725__$1,ast,type,component){
...
var union_key = cljs.core.get.call(null,map__29734__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
var children__$1 = cljs.core.get.call(null,map__29734__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var component__$1 = cljs.core.get.call(null,map__29734__$1,new cljs.core.Keyword(null,"component","component",1555936782));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [union_key,(function (){var G__29736 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,((function (map__29734,map__29734__$1,union_key,children__$1,component__$1,map__29730,map__29730__$1,children,map__29728,map__29728__$1,key,query,query_root,params,map__29725,map__29725__$1,ast,type,component){
return (function (p1__29719_SHARP_){
return om.next.impl.parser.ast__GT_expr.call(null,p1__29719_SHARP_,unparse_QMARK_);
});})(map__29734,map__29734__$1,union_key,children__$1,component__$1,map__29730,map__29730__$1,children,map__29728,map__29728__$1,key,query,query_root,params,map__29725,map__29725__$1,ast,type,component))
),children__$1);
if(!((component__$1 == null))){
return cljs.core.with_meta.call(null,G__29736,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component","component",1555936782),component__$1], null));
} else {
return G__29736;
}
})()], null);
});})(map__29730,map__29730__$1,children,map__29728,map__29728__$1,key,query,query_root,params,map__29725,map__29725__$1,ast,type,component))
...
return cljs.core.PersistentArrayMap.fromArray([key,(function (){var G__29737 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,((function (map__29730,map__29730__$1,children,map__29728,map__29728__$1,key,query,query_root,params,map__29725,map__29725__$1,ast,type,component){
return (function (p1__29720_SHARP_){
return om.next.impl.parser.ast__GT_expr.call(null,p1__29720_SHARP_,unparse_QMARK_);
});})(map__29730,map__29730__$1,children,map__29728,map__29728__$1,key,query,query_root,params,map__29725,map__29725__$1,ast,type,component))
),children);
if(!((component == null))){
return cljs.core.with_meta.call(null,G__29737,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component","component",1555936782),component], null));
} else {
return G__29737;
}
})()], true, false);
...
var args29742 = [];
var len__21324__auto___29756 = arguments.length;
var i__21325__auto___29757 = (0);
while(true){
if((i__21325__auto___29757 < len__21324__auto___29756)){
args29742.push((arguments[i__21325__auto___29757]));

var G__29758 = (i__21325__auto___29757 + (1));
i__21325__auto___29757 = G__29758;
continue;
} else {
}
break;
...
return cljs.core.vary_meta.call(null,G__29745,cljs.core.assoc,new cljs.core.Keyword(null,"om-path","om-path",-1911443978),path);
} else {
return G__29745;
}
} else {
...
var G__29760 = cljs.core.next.call(null,joins);
var G__29761 = ret;
joins = G__29760;
ret = G__29761;
continue;
} else {
var join__$1 = (function (){var G__29750 = join;
if(cljs.core.seq_QMARK_.call(null,join)){
return cljs.core.first.call(null,G__29750);
} else {
return G__29750;
}
})();
var join__$2 = (function (){var G__29751 = join__$1;
if(om.util.ident_QMARK_.call(null,join__$1)){
return cljs.core.PersistentHashMap.fromArrays([G__29751],[new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null)]);
} else {
return G__29751;
}
})();
var vec__29747 = om.util.join_entry.call(null,join__$2);
var key = cljs.core.nth.call(null,vec__29747,(0),null);
var sel = cljs.core.nth.call(null,vec__29747,(1),null);
...
var key__$1 = (function (){var G__29752 = key;
if(om.util.unique_ident_QMARK_.call(null,key)){
return cljs.core.first.call(null,G__29752);
} else {
return G__29752;
}
})();
var v = cljs.core.get.call(null,ret,key__$1);
var G__29762 = cljs.core.next.call(null,joins);
var G__29763 = (function (){var G__29753 = ret;
if(cljs.core.contains_QMARK_.call(null,ret,key__$1)){
return cljs.core.assoc.call(null,G__29753,key__$1,om.next.impl.parser.path_meta.call(null,v,cljs.core.conj.call(null,path,key__$1),sel__$1,union_entry));
} else {
return G__29753;
}
})();
...
return cljs.core.vary_meta.call(null,G__29754,cljs.core.assoc,new cljs.core.Keyword(null,"om-path","om-path",-1911443978),path);
} else {
return G__29754;
}
}
 ...
 */
om.next.impl.parser.parser = (function om$next$impl$parser$parser(p__29764){
var map__29831 = p__29764;
...
var config = map__29831__$1;
var read = cljs.core.get.call(null,map__29831__$1,new cljs.core.Keyword(null,"read","read",1140058661));
var mutate = cljs.core.get.call(null,map__29831__$1,new cljs.core.Keyword(null,"mutate","mutate",1422419038));
return ((function (map__29831,map__29831__$1,config,read,mutate){
return (function() {
...
var map__29865 = (function (){var G__29866 = cljs.core.assoc.call(null,env,new cljs.core.Keyword(null,"parser","parser",-1543495310),om$next$impl$parser$parser_$_self,new cljs.core.Keyword(null,"target","target",253001721),target,new cljs.core.Keyword(null,"query-root","query-root",359781888),new cljs.core.Keyword("om.next","root","om.next/root",-1714259778));
if(!(cljs.core.contains_QMARK_.call(null,env,new cljs.core.Keyword(null,"path","path",-188191168)))){
return cljs.core.assoc.call(null,G__29866,new cljs.core.Keyword(null,"path","path",-188191168),cljs.core.PersistentVector.EMPTY);
} else {
return G__29866;
}
})();
...
var env__$1 = map__29865__$1;
var path = cljs.core.get.call(null,map__29865__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var step = ((function (elide_paths_QMARK_,map__29865,map__29865__$1,env__$1,path,map__29831,map__29831__$1,config,read,mutate){
return (function om$next$impl$parser$parser_$_self_$_step(ret,expr){
var map__29889 = om.next.impl.parser.expr__GT_ast.call(null,expr);
...
var ast = map__29889__$1;
var query_SINGLEQUOTE_ = cljs.core.get.call(null,map__29889__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.call(null,map__29889__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.call(null,map__29889__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var params = cljs.core.get.call(null,map__29889__$1,new cljs.core.Keyword(null,"params","params",710516235));
var env__$2 = (function (){var G__29891 = cljs.core.merge.call(null,env__$1,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ast","ast",-860334068),ast,new cljs.core.Keyword(null,"query","query",-1288509510),query_SINGLEQUOTE_], null));
var G__29891__$1 = (((query_SINGLEQUOTE_ == null))?cljs.core.dissoc.call(null,G__29891,new cljs.core.Keyword(null,"query","query",-1288509510)):G__29891);
var G__29891__$2 = ((cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"...","...",-1926939749,null),query_SINGLEQUOTE_))?cljs.core.assoc.call(null,G__29891__$1,new cljs.core.Keyword(null,"query","query",-1288509510),query):G__29891__$1);
if(cljs.core.vector_QMARK_.call(null,key)){
return cljs.core.assoc.call(null,G__29891__$2,new cljs.core.Keyword(null,"query-root","query-root",359781888),key);
} else {
return G__29891__$2;
}
})();
...
var res = (function (){var G__29892 = (((type instanceof cljs.core.Keyword))?type.fqn:null);
switch (G__29892) {
case "call":
...
var G__29893 = ret;
var G__29893__$1 = ((ast_SINGLEQUOTE_ === true)?cljs.core.conj.call(null,G__29893,expr):G__29893);
if(cljs.core.map_QMARK_.call(null,ast_SINGLEQUOTE_)){
return cljs.core.conj.call(null,G__29893__$1,om.next.impl.parser.ast__GT_expr.call(null,ast_SINGLEQUOTE_));
} else {
return G__29893__$1;
}
} else {
...
}catch (e29894){var e_29898 = e29894;
if(cljs.core.truth_(om.next.impl.parser.rethrow_QMARK_.call(null,e_29898))){
throw e_29898;
} else {
cljs.core.reset_BANG_.call(null,error,e_29898);
}
}} else {
}
...
var G__29895 = ret;
var G__29895__$1 = ((!((value == null)))?cljs.core.assoc.call(null,G__29895,key,value):G__29895);
var G__29895__$2 = (cljs.core.truth_(cljs.core.deref.call(null,mut_ret))?cljs.core.assoc_in.call(null,G__29895__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [key,new cljs.core.Keyword(null,"result","result",1415092211)], null),cljs.core.deref.call(null,mut_ret)):G__29895__$1);
if(cljs.core.truth_(cljs.core.deref.call(null,error))){
return cljs.core.assoc.call(null,G__29895__$2,key,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("om.next","error","om.next/error",-1841983205),cljs.core.deref.call(null,error)], null));
} else {
return G__29895__$2;
}
}
}
});})(elide_paths_QMARK_,map__29865,map__29865__$1,env__$1,path,map__29831,map__29831__$1,config,read,mutate))
;
var G__29896 = cljs.core.reduce.call(null,step,(((target == null))?cljs.core.PersistentArrayMap.EMPTY:cljs.core.PersistentVector.EMPTY),query);
if(((target == null)) && (cljs.core.not.call(null,elide_paths_QMARK_))){
return om.next.impl.parser.path_meta.call(null,G__29896,path,query);
} else {
return G__29896;
}
});
...
;})(map__29831,map__29831__$1,config,read,mutate))
});
